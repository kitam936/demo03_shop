...
class ProductController extends Controller
{
    ...
    public function show0($id)
    {
        ...
        return view('product.show0',compact('product','skus','logIn_user'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if($request->type == 'sku'){
            ...
            return view('product.show',compact('product','skus','logIn_user'));
        }
        ...
        if($request->type == 'sh_total'){
            ...
            return view('product.show',compact('product','skus','datas','logIn_user'));
        }
