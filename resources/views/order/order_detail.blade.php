<x-app-layout>
    <x-slot name="header">
        ...
        <div class="ml-2 mb-2 md:mb-0">
            <button type="button" onclick="location.href='{{ route('analysis_index') }}'" class="w-32 h-8 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded ">Menu</button>
        </div>
        ...
        <div class="ml-2 mb-0 md:mb-0">
            <button type="button" onclick="location.href='{{ route('order_edit',['order'=>$order_hs->id])}}'" class="w-32 h-8 text-center text-sm text-white bg-green-500 border-0 py-1 px-2 focus:outline-none hover:bg-green-600 rounded ">編集</button>
        </div>
                        ...
                        <div class="-m-2">
                            <div class="p-2 mx-auto">
                                ...
                                <div class="p-2 w-full mx-auto">
                                    ...
                                    <div class="flex">
                                    <div class="relative">
                                        <label for="order_id" class="leading-7 text-sm  text-gray-800 ">ID</label>
                                        <div  id="order_id" name="order_id" value="{{$order_hs->id}}" class="h-8 w-32 text-sm bg-gray-100 bg-opacity-50 border rounded focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$order_hs->id}}
                                        </div>
                                    </div>
                                    <div class="relative">
                                        <label for="date" class="ml-2 leading-7 text-sm  text-gray-800 ">日付</label>
                                        <div  id="date" name="date" value="{{$order_hs->order_date}}" class="ml-2 h-8 w-48 text-sm bg-gray-100 bg-opacity-50 border rounded focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$order_hs->order_date}}
                                        </div>
                                    </div>
                                    </div>
                                    <div class="flex">
                                    <div class="relative">
                                        <label for="user_name" class="md:ml-2 leading-7 text-sm  text-gray-800 ">発注者</label>
                                    ...
                                    <div class="relative">
                                        <label for="sh_name" class="ml-2 leading-7 text-sm  text-gray-800 ">店名</label>
                                    ...
                                    <div class="relative">
                                        <label for="status" class="leading-7 text-sm  text-gray-800 ">status</label>
                                    ...
                                    <div class="flex">
                                        <div class="relative">
                                            ...
                                            <div  id="total_baika" name="total_baika" value="{{$order_total->total_baika}}" class="h-8 text-sm w-28 bg-gray-100 bg-opacity-50 border rounded focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$order_total->total_baika}}円
                                            </div>
                                        </div>
                                        <div class="relative ml-2">
                                            <label for="status" class="leading-7 text-sm  text-gray-800 dark:text-gray-200 ">原価計</label>
                                            <div  id="total_genka" name="total_genka" value="{{$order_total->total_genka}}" class="h-8 text-sm w-28 bg-gray-100 bg-opacity-50 border rounded focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$order_total->total_genka}}円
                                            </div>
                                        </div>
                                        <div class="relative ml-2">
                                            <label for="status" class="leading-7 text-sm  text-gray-800 dark:text-gray-200 ">数計</label>
                                            <div  id="total_pcs" name="total_pcs" value="{{$order_total->total_pcs}}" class="h-8 text-sm w-20 bg-gray-100 bg-opacity-50 border rounded focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$order_total->total_pcs}}枚
                                            </div>
                                        </div>
                                    </div>
                                    <div class="relative">
                                        <label for="comment" class="leading-7 text-sm  text-gray-800 ">comment</label>
