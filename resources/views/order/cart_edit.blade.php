<x-app-layout>
    <x-slot name="header">
        ...
        <div class="md:flex">
            ...
            <div class="flex">
                ...
                <button type="button" class="w-32 h-8 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded " onclick="location.href='{{ route('cart_index') }}'" >カートに戻る</button>
                </div>
    ...
    <div class="py-0 border md:pl-24 md:ml-20 md:w-full">
        {{-- <h1>店舗Report</h1> --}}
        <div class=" bg-white mx-auto sm:px-4 lg:px-4 border ">
            <table>
                <thead>
                    <tr>
                        {{-- <th>商品ID</th> --}}
