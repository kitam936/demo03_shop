    ...
    <x-slot name="header">
        ...
        <div class="flex">
            ...
            <div class="pl-2 mt-2  ml-8 ">
                <button type="button" class="w-32 h-8 text-center text-sm text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-700 rounded " onclick="location.href='{{ route('budget_progress_reset') }}'" >選択リセット</button>
            </div>
        </div>
