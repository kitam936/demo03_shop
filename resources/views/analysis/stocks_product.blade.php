    ...
    <x-slot name="header">
        ...
        <div class="flex">
            ...
            <div class="pl-2 mt-2  ml-8 ">
                <button type="button" class="w-32 h-8 text-center text-sm text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-700 rounded " onclick="location.href='{{ route('stocks_product_reset') }}'" >選択リセット</button>
            </div>
        </div>
        ...
        <form method="get" action="{{ route('stocks_product')}}" class="mt-4">
            ...
            <div class="flex">
                <div>
                <label for="type3" class="mr-5 leading-7 text-sm  text-gray-800 ">集計区分</label>
            ...
            <div class="flex md:ml-4">
                ...
                <div>
                <label for="sh_id" class="mr-5 leading-7 text-sm  text-gray-800 ">店 指定</label>
                <select class="w-32 h-8 rounded border text-sm items-center pt-1 md:ml-1" id="sh_id" name="sh_id" >
            ...
            <div class="flex md:ml-4">
                <div>
                <label for="unit_id" class="mr-2 md:mr-2 leading-7 text-sm  text-gray-800 ">Unit 指定</label>
                <select class="w-28 h-8 rounded text-sm pt-1 border mb-2 mr-6 md:ml-0" id="unit_id" name="unit_id" >
                ...
                <select class="w-28 h-8 rounded border text-sm items-center pt-1 md:ml-2" id="face" name="face" >
