    ...
    <x-slot name="header">
        ...
        <div class="flex">
            ...
            <div class="pl-2 mt-2  ml-8 ">
                <button type="button" class="w-32 h-8 text-center text-sm text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-700 rounded " onclick="location.href='{{ route('sales_total_reset') }}'" >選択リセット</button>
            </div>
        </div>
        ...
        <form method="get" action="{{ route('sales_total')}}" class="mt-4">
            ...
            <div class="flex mb-2">
                ...
                <select class="w-36 h-8 ml-0 md:ml-0 rounded text-sm items-center pt-1" id="YW1" name="YW1" type="number" >
                ...
                <div>
                <label for="YW2" class="items-center text-sm mt-2 ml-2 text-gray-800 leading-tight" >＊初期表示は直近週</label>
        ...
        <div class="md:flex">
            <div class="flex">
                ...
                <div>
                    <label for="season_code" class="mr-5 leading-7 text-sm  text-gray-800 ">季節 指定</label>
