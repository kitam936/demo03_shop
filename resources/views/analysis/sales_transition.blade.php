    ...
    <x-slot name="header">
        ...
        <div class="flex">
            ...
            <div class="pl-2 mt-2  ml-8 ">
                <button type="button" class="w-32 h-8 text-center text-sm text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-700 rounded " onclick="location.href='{{ route('sales_transition_reset') }}'" >選択リセット</button>
            </div>
        </div>
        ...
        <div >
                <div>
                    <label for="type2" class="mr-5 leading-7 text-sm  text-gray-800 ">集計期間単位を年度・月・週・日から選択</label>
        ...
        <div class="flex">
            <div class="flex mb-2">
                ...
                <div class="mt-00 md:mt-0">
                    <label for="YM1" class="mr-0 leading-7 text-sm  text-gray-800 ">＊初期表示は当月</label>
        ...
        <div class="md:flex">
            ...
            <div class="flex md:ml-4">
                ...
                <div>
                    ...
                    <select class="w-28 h-8 rounded text-sm pt-1 border mb-2 mr-6 md:ml-2" id="co_id" name="co_id" >
                ...
                <div>
                    ...
                    <select class="w-32 h-8 rounded border text-sm items-center pt-1 md:ml-2" id="sh_id" name="sh_id" >
        ...
        <div class="md:flex">
            ...
            <div class="flex md:ml-4">
                <div>
                    <label for="unit_id" class="mr-2 md:mr-2 leading-7 text-sm  text-gray-800 ">Unit指定</label>
                    <select class="w-28 h-8 rounded text-sm pt-1 border mb-2 mr-6 md:ml-2" id="unit_id" name="unit_id" >
