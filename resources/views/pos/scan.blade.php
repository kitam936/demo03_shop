<x-app-layout>
    ...
    <div class="ml-2 flex mb-4 mb-4 mt-2">
        ...
        <div class="ml-4 mt-2 md:ml-4 md:mt-0">
            <button type="button" class="w-24 h-8 text-center text-sm text-white bg-indigo-500 binventory-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded " onclick="location.href='{{ route('pos_index') }}'" >入力状況</button>
        </div>
        <div class="ml-4 mt-2 md:ml-4 md:mt-0">
            <button type="button" class="w-24 h-8 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded " onclick="location.href='{{ route('pos_result_index') }}'" >売上リスト</button>
        </div>
    </div>
