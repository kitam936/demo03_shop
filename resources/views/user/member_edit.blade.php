<x-app-layout>
    <x-slot name="header">
        ...
        <div class="ml-2 mb-2 md:mb-0">
            <button type="button" onclick="location.href='{{ route('memberlist') }}'" class="w-32 h-8 text-center text-sm text-white bg-indigo-400 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-600 rounded ">STAFFリスト</button>
        </div>
        </div>
                        ...
                        <div class="px-2 mx-auto">
                            <div class="flex ml-0 mb-2  md:mb-1">
                                <div class="relative ml-0 mt-2 px-0 py-1">
                                    <div >
                                    <label for="sh_id" class="leading-7 text-sm  text-gray-800 ">所属</label>
                                    </div>
                                    <div>
                                        <select class="w-60 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" id="sh_id" name="sh_id"  class="border">
                            ...
                            <div class="relative">
                                <label for="name" class="leading-7 text-sm  text-gray-800 ">名前</label>
                            ...
                            <div class="relative">
                                <label for="email" class="leading-7 text-sm  text-gray-800 ">Mail</label>
                            ...
                            <div class="p-2 ">
                                <label for="mailService" class="leading-7 text-sm  text-gray-800 ">メール配信</label>
                                <div class="relative flex justify-around">
                                    <div class="ml-2 w-24"><input type="radio" name="mailService" value="1" class="mr-2" @if($user->mailService == 1){ checked }@endif>配信可</div>
                                    <div class="w-24"><input type="radio" name="mailService" value="0" class="mr-2" @if($user->mailService == 0){ checked }@endif>配信不可</div>
                                </div>
                            </div>
                            <div class="relative">
                                <label for="user_info" class="leading-7 text-sm  text-gray-800 ">info</label>
                                <textarea id="user_info" name="user_info" rows="4" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $user->user_info }}</textarea>
                            </div>
                        </div>
