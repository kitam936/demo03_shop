<x-app-layout>
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('memberlist')}}" class="mt-4">
            ...
            <span class="items-center text-sm ml-2 mt-2 text-gray-800 leading-tight" >※キーワード検索　　　</span>
            <div class="md:flex">
                <div class="flex ml-2">
                <div class="flex mb-2 md:flex md:mb-4">
                         {{-- <label class="items-center ml-2 mr-1 text-sm mt-2 text-gray-800 leading-tight" >検索</label> --}}
                        <input class="w-40 h-8 ml-0 md:ml-4 rounded text-sm pt-1" id="search" placeholder="ワード入力" name="search"  class="border">
                </div>
