...
<x-app-layout>
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('my_sales_product')}}" class="mt-4">
            ...
            <div class="flex">
                <div>
                <label for="type3" class="mr-3 leading-7 text-sm  text-gray-800 ">集計区分切替　</label>
            ...
            <div class="flex mb-2">
                ...
                <select class="md:ml-8 w-36 h-8 rounded text-sm pt-1" id="YM1" name="YM1" type="number" class="border">
            ...
            <div class="flex">
                ...
                <select class="md:ml-8 w-28 h-8 rounded text-sm pt-1 border mb-2 mr-6 " id="brand_code" name="brand_code" type="number" >
            ...
            <table class="mx-auto table-auto bg-white w-full text-center whitespace-no-wrap">
                ...
                <tr>
                    ...
                    <td class="w-3/12 md:px-0 py-0">
                        ...
                        {{-- @if((\Request::get('type3') == "h") || (\Request::get('type3') == '0'))
