    ...
    <x-slot name="header">
        <h2 class="font-semibold mb-2 text-xl text-gray-800 leading-tight">
         ...
         <div class="ml-2 md:ml-4">
                    <button type="button" class="w-32 h-8 text-sm bg-indigo-500 text-white ml-2 hover:bg-indigo-600 rounded"  onclick="location.href='{{ route('memberlist') }}'" >STAFFリスト</button>
        </div>
