<x-app-layout>
    <x-slot name="header">
        ...
        <div class="ml-2 mb-2 md:mb-0">
            <button type="button" onclick="location.href='{{ route('product_index') }}'" class="w-32 h-8 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded ">商品一覧</button>
        </div>
        <div class="ml-4 mb-0">
                            ...
                            <div class="p-2 ">
                                <div class="p-2 w-full ">
                                    ...
                                    <div class="relative ml-2 mr-2">
                                        <label for="hinban_info" class="ml-1 leading-7 text-sm  text-gray-800 ">商品情報</label>
