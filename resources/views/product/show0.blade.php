<x-app-layout>
    <x-slot name="header">
        ...
        <div class="ml-2 mb-2 md:mb-0">
            <button type="button" onclick="location.href='{{ route('product_index') }}'" class="w-32 h-8 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded ">商品リスト</button>
        </div>
        @if($logIn_user->role_id <>10)
        <div class="ml-4 mb-0">
            <button type="button" class="w-32 h-8 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded " onclick="location.href='{{ route('sales_product') }}'" >商品別売上</button>
        </div>
        @endif
        </div>
        ...
        <div class="ml-10  ">
            <div class="flex">
            <label for="type" class="mr-5 leading-7 text-sm  text-gray-800 ">表示選択</label>
                        ...
                        <div class="-m-2">
                            <div class="p-2 ">
                                <div class="p-2 w-full ">
                                    <div class="flex">
                                    <div class="relative">
                                        <label for="brand_id" class="mr-2 leading-7 text-sm  text-gray-800 ">Brand</label>
                                    ...
                                    <div class="relative">
                                        <label for="hinban" class="mr-2 leading-7 text-sm  text-gray-800 ">品番</label>
                                    ...
                                    <div class="relative">
                                        <label for="year_code" class="mr-2 leading-7 text-sm  text-gray-800 ">年CD</label>
                                    ...
                                    {{--  <div class="relative">
                                        <label for="shohin_gun" class="mr-2 leading-7 text-sm  text-gray-800 ">商品群</label>
                                    ...
                                    <div class="relative">
                                        <label for="unit_id" class="mr-2 leading-7 text-sm  text-gray-800 ">Unit</label>
                                    ...
                                    <div class="relative">
                                        <label for="hinban_name" class="mr-2 leading-7 text-sm  text-gray-800 ">商品名</label>
                                    ...
                                    <div class="flex">
                                    <div class="relative">
                                        <label for="m_price" class="mr-2 leading-7 text-sm  text-gray-800 ">M売価</label>
                                    ...
                                    <div class="relative">
                                        <label for="price" class="mr-2 leading-7 text-sm  text-gray-800 ">現売価</label>
                                    ...
                                    <div class="relative ml-2 mr-2">
                                        <label for="hinban_info" class="mr-2 leading-7 text-sm  text-gray-800 ">商品情報</label>
                                ...
                                <div class="px-2 md:w-2/3 ">
                                    ...
                                    <div class="w-full mb-1">
                                        ...
                                        <img src="{{ asset('storage/public/images/'.$product->filename) }}">
                                        </a>
                                        @endif
