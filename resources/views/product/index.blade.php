    ...
    <x-slot name="header">
        ...
        <x-flash-message status="session('status')"/>
         ...
         <div class="flex">
            ...
            <div class="pl-2 mt-2 ml-4 ">
                <button type="button" class="w-32 h-8 text-center text-sm text-white bg-indigo-500 border-0 py-1 px-2 focus:outline-none hover:bg-indigo-700 rounded " onclick="location.href='{{ route('image_index') }}'" >画像リスト</button>
            </div>
