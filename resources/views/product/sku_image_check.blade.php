    ...
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('admin.sku_image_check')}}" class="mt-4">
            ...
            <div class="lg:flex">
                ...
                <div class="flex pl-2 mt-0 md:mt-0 md:ml-0 ml-0 ">
                    ...
                    <button type="button" class="w-32 h-8 bg-blue-500 text-sm text-white ml-0 hover:bg-blue-600 rounded lg:ml-2 " onclick="location.href='{{ route('admin.sku_image_csv') }}'" >CSVダウンロード</button>
                </div>
            ...
            <table class="md: bg-white table-auto w-full text-center whitespace-no-wrap">
               <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="w-2/8 md:px-4 py-1 text-left"  >{{ $image->unit }}</td>
