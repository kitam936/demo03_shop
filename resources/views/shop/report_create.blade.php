        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="-m-2">
                        <div class="mb-0">
                            <span class="items-center text-sm mt-2 text-gray-800 leading-tight" >店舗： 　</span>
                                @foreach ($shops as $shop)
                                <div class="flex pl-0 mt-0">
                                    <div class="pl-0  ml-0 md:ml-2 w-80 h-6 items-center bg-gray-100 border rounded text-gray-800 leading-tight" name="sh_id"  value="{{ $shop->id }}">{{ $shop->id }}--{{ $shop->shop_name }}</div>
                        ...
                        <div class="p-2 mx-auto">
                            <div class="relative">
                              <label for="report" class="leading-7  text-sm mt-2 text-gray-800 ">Report※必須</label>
                        ...
                        <div class="relative">
                            <label for="image1" class="leading-7  text-sm mt-2 text-gray-800 ">画像1</label>
                        ...
                        <div class="relative">
                            <label for="image2" class="leading-7  text-sm mt-2 text-gray-800 ">画像2</label>
                        ...
                        <div class="relative">
                            <label for="image3" class="leading-7  text-sm mt-2 text-gray-800 ">画像3</label>
                        ...
                        <div class="relative">
                            <label for="image4" class="leading-7  text-sm mt-2 text-gray-800 ">画像4</label>
