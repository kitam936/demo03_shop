        ...
        <form method="get" action="{{ route('shop_index')}}" class="mt-4">
            ...
            <div class="flex">
                ...
                <div class="flex mb-2 md:flex md:mb-4">
                        ...
                        <input class="w-44 h-8 ml-0 md:ml-4 rounded text-sm pt-1" id="search" placeholder="ワード入力検索" name="search"  class="border">
            ...
            <table class="md:w-full bg-white table-auto w-full text-center whitespace-no-wrap">
               <thead>
                ...
                <tbody>
                    ...
                    <tr>                       
                        <td class="w-2/12 md:1/12 text-sm md:px-4 py-1 text-center"> {{ $shop->id }} </td>                       
                        <td class="w-2/12 md:1/12 text-sm md:px-4 py-1 text-center"> {{ $shop->area_name }} </td>
                        <td class="w-3/12 md:2/12 text-sm md:px-4 py-1 text-center">{{ Str::limit($shop->co_name,15) }}</td>
                        @if(Auth::User()->shop_id <> 106)
